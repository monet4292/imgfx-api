---
name: kiro-onboard
description: Generate 3 onboarding files into <project>/.codex for AI coding agents.
...
## Objective
Produce concise onboarding docs to help AI coding agents build, test, and modify this repository accurately and safely.

---

## Files To Generate

### **1. $ROOT/.codex/product.md**
...
1. Inventory the repository: README, docs, configs, scripts, CI pipelines.  
